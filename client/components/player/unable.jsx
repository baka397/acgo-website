        ...
        return (
            <div className="app-tip m-t-hg">
                ...
                <div className="app-tip-message">
                    ...
                    <p>
                        <a className="btn btn-primary m-r" href="/download"><i className="icon icon-download m-r-sm"></i>下载客户端</a>
                        <a className="btn btn-info" href={url} target="_blank"><i className="icon icon-open m-r-sm"></i>直接访问地址</a>
                    </p>
                </div>
            </div>
        )
