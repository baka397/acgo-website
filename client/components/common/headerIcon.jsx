        ...
        return (
            <div className="app-header-icon">
                {icons.map((icon)=>{
                    ...
                    case 'submin':
                        return (<a className="btn-success header-icon-min" key="min" title="最小化" onClick={()=>{this.handleIconClick('submin');}}></a>);
                    case 'max':
                        return (<a className="btn-info header-icon-max" key="max" title="最大化" onClick={()=>{this.handleIconClick('max');}}></a>);
                    case 'submax':
                        return (<a className="btn-info header-icon-max" key="max" title="最大化" onClick={()=>{this.handleIconClick('submax');}}></a>);
                    case 'close':
                        return (<a className="btn-danger header-icon-close" key="close" title="关闭" onClick={()=>{this.handleIconClick('close');}}></a>);
                    case 'subclose':
                        return (<a className="btn-danger header-icon-close" key="close" title="关闭" onClick={()=>{this.handleIconClick('subclose');}}></a>);
                    case 'refresh':
